...
namespace PeliculasApi.Tests.PruebasUnitarias
{
    ...
    public class CuentasControllerTest : BasePruebas
    {
        ...
        public async Task UsuarioNoPuedeLoguearse()
        {
            ...
            var userInfo = new UserInfo() { Email = "prueba@mail.com", Password = "MalPassword" };
        ...
        public async Task UsuarioPuedeLoguearse()
        {
            ...
            var controller = ConstruirCuentasController(nombreBD);
            var userInfo = new UserInfo() { Email = "prueba@mail.com", Password = "Aa123456." };
            var respuesta = await controller.Login(userInfo);
        ...
        private CuentasController ConstruirCuentasController(string nombreBD)
        {
            ...
            {
                {"JWT:key", "8y/B?E(H+MbQeThVmYq3t6w9z$C&F)J@NcRfUjXnZr4u7x!A%D*G-KaPdSgVkYp3" }
            };
